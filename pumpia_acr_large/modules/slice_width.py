"""
Slice width for Large ACR Phantom
"""
import math
...
from pumpia_acr_large.large_acr_context import LargeACRContextManagerGenerator, LargeACRContext
...
class LargeACRSliceWidth(PhantomModule):
    """
    Calculates slice width for the large ACR phantom by fitting to a flat top gaussian.
    ...
    def draw_rois(self, context: LargeACRContext, batch: bool = False) -> None:
