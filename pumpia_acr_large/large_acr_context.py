"""
Contains context handling for large ACR phantom
"""
...
class LargeACRContext(PhantomContext):
    """
    Context for Large ACR Phantom.
    """
...
class LargeACRContextManager(PhantomContextManager):
    """
    ...
    def __init__(self,
                 ...
                 text: float | str = "Large ACR Context",
                 *,
                 border: ScreenUnits = ...,
    ...
    def get_context(self, image: Series | Instance) -> LargeACRContext:
        ...
        if self.auto_phantom_manager.mode_var.get() == "fine tune":
            ...
            return LargeACRContext(boundary_context.xmin,
...
class LargeACRContextManagerGenerator(PhantomContextManagerGenerator[LargeACRContextManager]):
    """
    Generator for LargeACRContextManager.
    """
    context_manager_type = LargeACRContextManager
